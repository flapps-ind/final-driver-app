                    ...
                    <div className="bg-[#2a3a4a]/50 border border-[#00d9b8]/20 rounded-2xl p-4 space-y-4 animate-in fade-in slide-in-from-top-4 duration-300">
                        ...
                        <div className="space-y-1">
                            ...
                            <p className="text-xs text-[#8b92a5] leading-relaxed">
                                {activeEmergency?.description || "Live SOS received. Proceed immediately to the marked location."}
                            </p>
                        </div>
                    ...
                    {recentAlerts.length > 0 ? (
                        recentAlerts.map((alert, idx) => (
                            <AlertItem
                                ...
                                time={alert.time}
                                severity={alert.severity?.toLowerCase() === 'high' ? 'high' : 'medium'}
                            />
                        ))
                    ) : (
                        <p className="text-[10px] text-[#8b92a5] italic">No recent alerts</p>
                    )}
                </div>
            </div>
        </aside>
