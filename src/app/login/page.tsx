    ...
    return (
        <main className="min-h-screen flex items-center justify-center bg-[#0a1628] bg-gradient-to-br from-[#0a1628] to-[#152238] p-4 font-sans text-white border-[10px] border-[#0a1628]">
            <div className="w-full max-w-6xl flex flex-col lg:flex-row bg-[#1e2d3d]/50 backdrop-blur-xl rounded-3xl overflow-hidden border border-[#2a3f5f] shadow-2xl">
                    ...
                    <div className="space-y-12">
                        ...
                        <div className="space-y-6">
                            <div className="inline-flex items-center gap-2 bg-[#00ffcc]/10 px-3 py-1 rounded-full border border-[#00ffcc]/20">
                                ...
                                <span className="text-[10px] font-bold text-[#00ffcc] tracking-widest uppercase">Dispatch Ready</span>
                            </div>
                            <h1 className="text-5xl font-bold leading-tight">
                                Driver <span className="text-[#00ffcc]">Log In</span>
                            </h1>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="bg-[#0f1b2e]/50 p-4 rounded-xl border border-[#2a3f5f] group hover:border-[#00ffcc]/50 transition-all cursor-default">
                                <Navigation className="text-[#00ffcc] mb-3 transition-transform group-hover:scale-110" size={24} />
                                <h3 className="font-bold text-sm mb-1">Priority Routing</h3>
                                <p className="text-[10px] text-[#8b9bb8]">GPS-based emergency routing</p>
                            </div>
                            <div className="bg-[#0f1b2e]/50 p-4 rounded-xl border border-[#2a3f5f] group hover:border-[#00ffcc]/50 transition-all cursor-default">
                                <Activity className="text-[#00ffcc] mb-3 transition-transform group-hover:scale-110" size={24} />
                                <h3 className="font-bold text-sm mb-1">Fleet Sync</h3>
                                <p className="text-[10px] text-[#8b9bb8]">Real-time unit coordination</p>
                            </div>
                        </div>
                    </div>
                ...
                <section className="flex-1 p-10 lg:p-16 flex items-center justify-center bg-transparent">
                    <div className="w-full max-w-md space-y-8">
                        <div className="space-y-2">
                            <h2 className="text-2xl font-bold">Welcome Back</h2>
                            <p className="text-[#8b9bb8]">Enter your credentials to access the dashboard</p>
                        </div>
                        ...
                        <form onSubmit={handleLogin} className="space-y-6">
                            <div className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative group">
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-[#0f1b2e] border border-[#2a3f5f] rounded-xl py-3.5 pl-12 pr-4 text-white placeholder:text-[#8b9bb8]/50 focus:outline-none focus:ring-1 focus:ring-[#00ffcc] focus:border-[#00ffcc] transition-all"
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="space-y-2">
                                    <div className="flex justify-between items-center ml-1">
                                        <label className="text-xs font-bold text-[#8b9bb8] uppercase tracking-wider">Password</label>
                                        <Link href="#" className="text-[10px] font-bold text-[#00ffcc] hover:underline uppercase tracking-wider">Forgot?</Link>
                                    </div>
                                    <div className="relative group">
                                        <div className="absolute left-4 top-1/2 -translate-y-1/2 text-[#8b9bb8] group-focus-within:text-[#00ffcc] transition-colors">
                                            <Lock size={18} />
                                        ...
                                        <input
                                            ...
                                            placeholder="••••••••"
                                            className="w-full bg-[#0f1b2e] border border-[#2a3f5f] rounded-xl py-3.5 pl-12 pr-12 text-white placeholder:text-[#8b9bb8]/50 focus:outline-none focus:ring-1 focus:ring-[#00ffcc] focus:border-[#00ffcc] transition-all"
                                        />
                                        <button
                                            type="button"
                            ...
                            <button
                                type="submit"
                                disabled={isLoading}
                                className="w-full bg-[#00ffcc] hover:bg-[#00e5b8] text-[#0a1628] font-bold py-4 rounded-xl flex items-center justify-center gap-3 transition-all active:scale-[0.98] shadow-[0_0_20px_rgba(0,255,204,0.3)] disabled:opacity-50 disabled:cursor-not-allowed group"
                            >
